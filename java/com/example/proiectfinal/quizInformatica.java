...
public class quizInformatica extends AppCompatActivity {
    RadioButton raspA, raspB, raspC, raspD;
    TextView tvScor, tvIntrebare;
    private RaspunsuriInfo vectIntrebari = new RaspunsuriInfo();
    private String rasp;
    private int scor = 0;
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_informatica);
