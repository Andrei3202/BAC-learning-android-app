...
public class quizFizica extends AppCompatActivity {
    RadioButton raspA, raspB, raspC, raspD;
    TextView tvScor, tvIntrebare;
    private RaspunsuriFizica vectIntrebari = new RaspunsuriFizica();
    private String rasp;
    private int scor = 0;
    ...
    protected void onCreate (Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_quiz_fizica);
